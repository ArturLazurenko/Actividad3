...
public class Actividades {
 ...
 public static void main(String[] args) {
        ...
        if (edad <= 13) {
            System.out.println("Hola "+ nombre + " eres eres un niño.");
...
Autor: Greg
Total de ejemplares: 5
Ejemplares prestados: 2
...
**Salida esperada**  
`¿Cuántos productos va a capturar? (1 a 5): 1
...
Porcentaje de utilidad general: 20
----------------------------------------------------
Nombre, Costo, Impuesto, Precio Final
----------------------------------------------------
caja, 150.0, 15.0, 207.0
--------------------------------------------------------`
